...
function TooltipContent({
  ...
  // The arrow can't be glass (it's a rotated square), so it wears solid
  // bg-card — near-identical to glass-panel's card-over-blur surface. A
  // translucent arrow would double up where it overlaps the bubble.
  return (
